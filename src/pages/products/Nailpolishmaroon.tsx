...
const Nailpolishmaroon = () => {
  const productData = {
    id: 4,
    name: "BEAUTY COLOUR Nail Polish Maroon Edition",
    slug: "NP-Maroon",
    category: "Nail Polish",
    images: [
      "/produk/Nail-Polish/OIl Nail Polish/Maroon-nail-polish.jpg",
     
    ],
    description: ` BEAUTY COLOUR Nail Polish Maroon Edition bersertifikat BPOM.
    NA 
...
export default Nailpolishmaroon;
