...
const Nailpolishblack = () => {
  const productData = {
    id: 7,
    name: "BEAUTY COLOUR Nail Polish Black Edition",
    slug: "NP-Black-edition",
    category: "Nail Polish",
    images: [
      "/produk/Black edition/black-edition.png",
     
    ],
    description: ` BEAUTY COLOUR Nail Polish Black Edition bersertifikat BPOM.
    NA 
...
export default Nailpolishblack;
