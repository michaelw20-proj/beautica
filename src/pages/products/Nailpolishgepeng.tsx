...
const Nailpolishgepeng = () => {
  const productData = {
    id: 2,
    name: "BEAUTY COLOUR Nail Polish Gepeng",
    slug: "NP-Gepeng",
    category: "Nail Polish",
    images: [
      "/produk/Nail-Polish/gepeng/gepeng-1.png",
     
    ],
    description: `BEAUTY COLOUR Nail Polish Gepeng bersertifikat BPOM.
...
export default Nailpolishgepeng;
