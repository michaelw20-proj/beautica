...
const Eyeshadowbestofme = () => {
  const productData = {
    id: 7,
    name: "BEAUTICA Eye Shadow palette Best Of Me ",
    slug: "es-bestofme",
    category: "Eyeshadow",
    images: [
      "#",
    ...
    BEAUTICA Eye Shadow palette Best Of Me bersertifikat BPOM.
    Eyeshadow = #
    Blush = #
    NKIT230000924`,
...
export default Eyeshadowbestofme;
